...
<div id="get_quote" class="text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Please remember that the items will take 2-3 days to be delivered. This service is only available to our customers. Did you fill out the quotation form?
...
<div id="if_filled_quatation" class="container margin_60" style="display:none;">
            <h5 style="margin-top:0">Terms & Conditions</h5>
            <p class="add_bottom_45">Period of free rental service is 10 days. Thereafter a 10% fee from the refund will be deducted until the box arrives.</p>
            <div class="row">
                                      ...
                                      <div class="row">
                                          ...
                                          {!! Form::hidden('price', $rental_service->price) !!}
                                              {!! Form::select($rental_service->id.'___rental',
                                                               $rental_service->getQuantity($rental_service->max_quantity), 0,
